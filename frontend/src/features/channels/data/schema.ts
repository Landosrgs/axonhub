...
// Regex Filter
export const regexFilterModeSchema = z.enum(['regex', 'anchor']);
export type RegexFilterMode = z.infer<typeof regexFilterModeSchema>;

export const regexFilterRuleSchema = z.object({
  pattern: z.string().min(1),
  mode: regexFilterModeSchema,
  enabled: z.boolean(),
});
export type RegexFilterRule = z.infer<typeof regexFilterRuleSchema>;
...
export const channelSettingsSchema = z.object({
  ...
  regexFilters: z.array(regexFilterRuleSchema).optional().nullable(),
});
